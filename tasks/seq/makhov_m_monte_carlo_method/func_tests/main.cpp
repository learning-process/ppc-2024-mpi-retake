...
TEST(makhov_m_monte_carlo_method_seq, func_is_x_pow2) {
  ...
  task_data_seq->inputs_count.emplace_back(1);
  task_data_seq->inputs_count.emplace_back(1);  // Информация о размерности интеграла
...
TEST(makhov_m_monte_carlo_method_seq, func_is_xx_plus_yy_plus_zz) {
  ...
  task_data_seq->inputs_count.emplace_back(1);
  task_data_seq->inputs_count.emplace_back(1);
  task_data_seq->inputs_count.emplace_back(3);  // Информация о размерности интеграла
  task_data_seq->outputs.emplace_back(reinterpret_cast<uint8_t *>(answerPtr));
  task_data_seq->outputs_count.emplace_back(1);
