...
TEST(shuravina_o_contrast_seq, test_min_max_values) {
  ...
  shuravina_o_contrast::ContrastTaskSequential test_task_seq(task_data_seq);
...
TEST(shuravina_o_contrast_seq, test_random_values) {
  constexpr size_t kCount = 256;
