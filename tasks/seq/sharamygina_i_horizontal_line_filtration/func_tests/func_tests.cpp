...
TEST(sharamygina_i_horizontal_line_filtration, WrongRowsTest) {
  int rows = 2;
  int cols = 4;
...
TEST(sharamygina_i_horizontal_line_filtration, WrongColsTest) {
  int rows = 4;
  int cols = 2;
...
TEST(sharamygina_i_horizontal_line_filtration, EmptyInputTest) {
  int rows = 4;
  int cols = 4;
...
TEST(sharamygina_i_horizontal_line_filtration, WrongInputCountTest) {
  int rows = 4;
  int cols = 4;
...
TEST(sharamygina_i_horizontal_line_filtration, EmptyOutputCountTest) {
  int rows = 4;
  int cols = 4;
...
TEST(sharamygina_i_horizontal_line_filtration, EmptyOutputTest) {
  int rows = 4;
  int cols = 4;
