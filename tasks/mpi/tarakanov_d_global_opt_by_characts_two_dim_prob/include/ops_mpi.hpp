...
class GlobalOptSequential : public ppc::core::Task {
 public:
  explicit GlobalOptSequential(std::shared_ptr<ppc::core::TaskData> task_data_) : Task(std::move(task_data_)) {}
...
class GlobalOptMpi : public ppc::core::Task {
 public:
  explicit GlobalOptMpi(std::shared_ptr<ppc::core::TaskData> task_data_) : Task(std::move(task_data_)) {}
  bool PreProcessingImpl() override;
  bool ValidationImpl() override;
  bool RunImpl() override;
  bool PostProcessingImpl() override;
