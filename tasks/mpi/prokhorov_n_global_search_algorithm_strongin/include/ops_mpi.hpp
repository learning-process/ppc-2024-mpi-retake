...
class TestTaskSequential : public ppc::core::Task {
 public:
  ...
  double stronginAlgorithm(double la, double b, double eps, double r, const std::function<double(double)> &f);
...
class TestTaskParallel : public ppc::core::Task {
 public:
  ...
  bool RunImpl() override;
  bool PostProcessingImpl() override;
  double stronginAlgorithmParalel(double a, double b, const std::function<double(double *)> &f, double eps = 0.0001);
