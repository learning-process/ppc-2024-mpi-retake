...
TEST(shishkarev_a_sum_of_vector_elements_mpi, test_pipeline_run) {
  ...
  ASSERT_TRUE(MPIVectorSumParallel->ValidationImpl());
  MPIVectorSumParallel->PreProcessingImpl();
  MPIVectorSumParallel->RunImpl();
  MPIVectorSumParallel->PostProcessingImpl();
